...
Privateの準備段階や機能が未有効の場合、フォームは利用できません。ボタンが表示されない場合も、未修正の詳細を公開Issueへ投稿しないでください。メンテナーはPublic化後に機能の有効化・報告導線・通知設定を確認し、`release-readiness.json`の`security_reporting_verified`へ確認結果を記録します。`false`の間は受付確認未完了です。
